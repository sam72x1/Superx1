...
class MomentumResult:
    ...
    # الحجم التراكمي **الفعلي** للجلسة (§4): في البريماركت/الأفترهاوس يُحسب من
    # شموع الجلسة لا من snap.day_volume (الذي قد يكون صفرًا/قديمًا). يُستخدم
    # لعرض قيمة التداول على البطاقة — مؤشّر السيولة الذي يحدّد أقصى مركز آمن.
